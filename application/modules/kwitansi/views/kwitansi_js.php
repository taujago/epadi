    ...
    { 
    	swal({   
          ...
          $.ajax({
                type: "POST",
                data: {id:list_id},
                url: "<?php echo site_url("master_tujuan/hapus")?>",
                dataType: "JSON",
...
function edit() {
    ...
    save_method = 'update';
    $.ajax({
        url : "<?php echo site_url('master_tujuan/edit')?>/" + list_id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id_tujuan"]').val(data.id_tujuan);
            $('[name="tujuan"]').val(data.tujuan);
            $('[name="jenis_tujuan"]').val(data.jenis_tujuan);
...
function simpan(){
   	var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('master_tujuan/add')?>";
    } else {
        url = "<?php echo site_url('master_tujuan/update')?>";
    }
...
function kw()
{
    ...
    { 
      var l = "L";
      var p = "P";
      window.open('<?php echo site_url("$controller/pdf_kw/") ?>/'+list_id+'/'+p);   
...
function rin()
{
    ...
    { 
      var l = "L";
      var p = "P";
      window.open('<?php echo site_url("$controller/pdf_kw_rincian/") ?>/'+list_id+'/'+p);   
