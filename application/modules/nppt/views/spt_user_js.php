    ...
    $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
     ...
     table = $('#datable_1').DataTable({
        ...
        initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo site_url("$controller/get_data_spt_user")?>", "type": "POST"},
                  columns: [
                            {
                              "data": "cek",
                               "orderable": false
...
function reload_table()
{
 ...
 function simpan_laporan(){
    var url;
        ...
        url = "<?php echo site_url('nppt/update_spt_user')?>";
   

    $('#form_spt_user').form('submit',{
        url: url,
        onSubmit: function(){
        ...
        success: function(result){
          ...
          // return false;
            ...
            swal.close();
                ...
                swal.close();
                  $("#modal_spt_user").modal("hide");   
                  window.location.href="<?php echo site_url("nppt/spt_user_laporan") ?>";
               } 
           });
            reload_table();
          }
