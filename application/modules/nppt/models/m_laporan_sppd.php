...
class m_laporan_sppd extends CI_Model {
  	var $table = 'nppt';
  	var $column_order = array('','id_nppt_detail','nama','no_spt','maksud','tgl_pergi','tgl_kembali','tanggal_laporan');
  	var $column_search = array('maksud','nama','no_spt','tgl_pergi','tgl_kembali','tanggal_laporan'); 
