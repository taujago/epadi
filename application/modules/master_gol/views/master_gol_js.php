    ...
    { 
    	swal({   
          ...
          $.ajax({
                type: "POST",
                data: {id:list_id},
                url: "<?php echo site_url("master_gol/hapus")?>",
                dataType: "JSON",
...
function edit() {
    ...
    save_method = 'update';
    $.ajax({
        url : "<?php echo site_url('master_gol/edit')?>/" + list_id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            $('[name="id_master_gol"]').val(data.id_master_gol);
            $('[name="master_gol"]').val(data.master_gol);
...
function simpan(){
   	var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('master_gol/add')?>";
    } else {
        url = "<?php echo site_url('master_gol/update')?>";
    }
