    ...
    { 
    	swal({   
          ...
          $.ajax({
                type: "POST",
                data: {id:list_id},
                url: "<?php echo site_url("master_transportasi/hapus")?>",
                dataType: "JSON",
...
function edit() {
    ...
    save_method = 'update';
    $.ajax({
        url : "<?php echo site_url('master_transportasi/edit')?>/" + list_id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
...
function simpan(){
   	var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('master_transportasi/add')?>";
    } else {
        url = "<?php echo site_url('master_transportasi/update')?>";
    }
