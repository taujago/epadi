  ...
  <aside class="main-sidebar">
     <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> <?php echo ucfirst($this->session->userdata("operator_level")) ?> Online</a>
        </div>
      </div>
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php 
            ...
            if ($this->session->userdata("operator_level") == "user") {?>
        ...
        <?php 
          if ($this->uri->segment(1) == "master_pegawai" or $this->uri->segment(1) == "master_golongan" or $this->uri->segment(1) == "master_tujuan" or $this->uri->segment(1) == "master_biaya"  or $this->uri->segment(1) == "master_gol" or $this->uri->segment(1) == "master_transportasi" or $this->uri->segment(1) == "program" or $this->uri->segment(1) == "master_transportasi" or $this->uri->segment(1) == "master_anggaran") {
            $ck = "treeview active";
          } else {
            $ck = "treeview ";
          }
        ...
        <?php 
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo site_url("master_anggaran") ?>"><i class="fa fa-circle-o"></i> Anggaran Kegiatan</a></li>
        ...
        <li class="header"><?php echo strtoupper($this->session->userdata("operator_level")) ?></li>
        ...
        <?php 
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url("operator_setting") ?>"><i class="fa fa-circle-o"></i>  Instansi</a></li>
            <li><a href="<?php echo site_url("operator_setting/kop") ?>"><i class="fa fa-circle-o"></i>  Aplikasi </a></li>
          </ul>
        </li>
        <?php 
         ...
         <li class="<?php echo $ckl ?>">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url("maintenance/backup") ?>"><i class="fa fa-circle-o"></i>  Backup</a></li>
            <li><a href="<?php echo site_url("maintenance/restore") ?>"><i class="fa fa-circle-o"></i>  Restore </a></li>
          </ul>
        </li>
        <?php
          }
         ...
         <?php
          if ($this->session->userdata("operator_level") == "user") {?>
             <li><a href="<?php echo site_url("users/user") ?>"><i class="fa fa-file-text-o"></i> Profil</a></li>
