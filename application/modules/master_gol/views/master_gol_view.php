        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form  id="form"  method="post" class="form-horizontal">
                <input type="hidden" value="" name="id_master_gol"/> 
                 
               
                <div class="form-group row">
                   <label for="example-text-input" class="col-sm-2 col-form-label">Gologngan</label>
                      <div class="col-sm-10">
                        <input class="form-control" type="text" name="master_gol"  id="example-text-input" >
