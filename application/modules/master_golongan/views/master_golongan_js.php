    ...
    { 
    	swal({   
          ...
          $.ajax({
                type: "POST",
                data: {id:list_id},
                url: "<?php echo site_url("master_golongan/hapus")?>",
                dataType: "JSON",
...
function edit() {
    ...
    save_method = 'update';
    $.ajax({
        url : "<?php echo site_url('master_golongan/edit')?>/" + list_id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
...
function simpan(){
   	var url;
    if(save_method == 'add') {
        url = "<?php echo site_url('master_golongan/add')?>";
    } else {
        url = "<?php echo site_url('master_golongan/update')?>";
    }
